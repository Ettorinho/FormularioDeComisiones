        ...
        <div class="px-4 py-5 my-5 text-center">
            ...
            <div class="col-lg-6 mx-auto">
                ...
                <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                    ...
                    <a href="${pageContext.request.contextPath}/comisiones/buscarPorDni" class="btn btn-primary btn-lg px-3">Buscar Miembros</a>
                    ...
                    <a href="${pageContext.request.contextPath}/actas/new" class="btn btn-primary btn-lg px-3">📝 Crear Acta de Reunión</a>                    
